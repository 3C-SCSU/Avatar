...
def manual_drone_control_window(items, get_drone_action, window1):
    ...
    top_right = [
        [sg.Text("Flight Log")],
        [sg.Listbox(values=[], size=(30, 6), key="LOG")],
    ]
    bottom_center = [
        [sg.Button("Down", size=(8, 2), image_filename="./GUI_Pics/down.png")]
    ]
    ...
    manual_drone_control_layout = [
        [
            ...
            sg.Push(),
            sg.Column(top_center, pad=((55, 0), (0, 0))),
            sg.Push(),
            sg.Column(top_right),
        ],
        [
            sg.Push(),
            sg.Push(),
            sg.Button("Forward", size=(8, 2), image_filename="./GUI_Pics/Forward.png"),
            sg.Push(),
            sg.Push(),
        ],
        [
            sg.Button(
                "Turn Left", size=(8, 2), image_filename="./GUI_Pics/turnLeft.png"
            ),
            ...
            sg.Button(
                "Turn Right", size=(8, 2), image_filename="./GUI_Pics/turnRight.png"
            ),
        ],
        [sg.Button("Back", size=(8, 2), image_filename="./GUI_Pics/back.png")],
        [
            sg.Button("Connect", size=(8, 2), image_filename="./GUI_Pics/connect.png"),
            sg.Push(),
            sg.Push(),
            sg.Column(bottom_center, pad=((55, 0), (0, 0))),
            sg.Push(),
            sg.Button("Takeoff", size=(8, 2), image_filename="./GUI_Pics/takeoff.png"),
