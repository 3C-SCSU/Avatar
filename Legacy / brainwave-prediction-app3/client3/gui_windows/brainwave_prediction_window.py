...
def brainwave_prediction_window(window1, get_drone_action, use_brainflow):
    ...
    top_left = [
        ...
        [
            sg.Button(
                "Read the file...", size=(40, 5), image_filename="./GUI_Pics/brain.png"
            )
        ],
        ...
        [
            sg.Button("Not correct...", size=(14, 3)),
    ...
    bottom_left = [
        [sg.Text("Flight Log")],
        [sg.Listbox(values=flight_log, size=(30, 6), key="LOG")],
    ]
    ...
    brainwave_prediction_layout = [
        ...
        [
            sg.Button("Connect", size=(8, 2), image_filename="./GUI_Pics/connect.pngg"),
            sg.Push(),
        ],
    ]

    brainwave_prediction_window = sg.Window(
        "Brainwave Prediction",
        brainwave_prediction_layout,
        size=(1200, 800),
