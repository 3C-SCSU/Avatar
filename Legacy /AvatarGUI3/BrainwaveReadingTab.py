...
class Ui_Avatar(object):
    ...
    def setupUi(self, Avatar):  # Avatar should be a QMainWindow, not a QWidget
        ...
        self.manualcontrol_2.setStyleSheet(
            "QPushButton {\n"
            "    background-color: rgb(36, 44, 77); /* Default background color */\n"
        ...
        self.notwhatiwasthinking.setStyleSheet(
            "QPushButton {\n"
            "    background-color: rgb(36, 44, 77); /* Default background color */\n"
            "    color: white;\n"
            "    border: none;\n"
        ...
        self.keepdronealive.setStyleSheet(
            "QPushButton {\n"
            "    background-color: rgb(36, 44, 77); /* Default background color */\n"
            "    color: white;\n"
            "    border: none;\n"
        ...
        self.dronealivetext.setStyleSheet(
        ...
        self.flightlogspace.setStyleSheet(
            "QTextEdit{\n    background-color: white;\n}\n"
        )
        ...
        self.consolelogspace.setStyleSheet(
            "QTextEdit{\n    background-color: white;\n}\n"
        )
    ...
    def retranslateUi(self, Avatar):
        ...
        self.notwhatiwasthinking.setText(
            _translate("Avatar", "Not What I Was Thinking")
        )
    ...
    def not_thinking(self):
        ...
        drone_input = (
            self.dronealivetext.toPlainText()
            if self.dronealivetext.toPlainText()
            else "manual input"
        )
        ...
        for i, data in enumerate(prediction_record):
            self.prediction.setItem(
                self.prediction.rowCount() - 1, i, QTableWidgetItem(str(data))
            )
