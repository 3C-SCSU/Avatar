...
# ==================================================
BASE_DATA_PATH = r"C:\Users\yaskk\JAX Random Forest NAO Control\Professor Data\data\data" # Change according to your path #
...
def train_step_improved(state, batch_x, batch_y, rng):
    """Improved training step with BatchNorm and augmentation"""
...
def eval_step_improved(state, batch_x, batch_y):
    """Evaluation step with BatchNorm"""
