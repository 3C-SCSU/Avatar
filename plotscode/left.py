...
def main():
    ...
    r_script_path = "/Avatar/plots/left.R"

    # script path for left : /Avatar/plots/left.R
    ...
    file_path = "/Avatar/plots/plot_waves/brainwaves-csv/left"
    analysis = BrainWaveAnalysis(file_path)

    # file path for left : /Avatar/plots/plot_waves/brainwaves-csv/left
