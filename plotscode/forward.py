...
def main():
    ...
    r_script_path = "/Avatar/plots/forward.R"

    # script path for forward : /Avatar/plots/forward.R
    ...
    file_path = "/Avatar/plots/plot_waves/brainwaves-csv/forward"
    analysis = BrainWaveAnalysis(file_path)

    # file path for forward : /Avatar/plots/plot_waves/brainwaves-csv/forward
