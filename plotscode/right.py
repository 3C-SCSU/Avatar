...
def main():
    ...
    r_script_path = "/Avatar/plots/right.R"

    # script path for right : /Avatar/plots/right.R
    ...
    file_path = "/Avatar/plots/plot_waves/brainwaves-csv/right"
    analysis = BrainWaveAnalysis(file_path)

    # file path for right : /Avatar/plots/plot_waves/brainwaves-csv/right
