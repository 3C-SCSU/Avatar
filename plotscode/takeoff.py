...
def main():
    ...
    r_script_path = "/Avatar/plots/takeoff.R"

    # script path for takeoff : /Avatar/plots/takeoff.R
    ...
    file_path = "/Avatar/plots/plot_waves/brainwaves-csv/takeoff"
    analysis = BrainWaveAnalysis(file_path)

    # file path for takeoff : /Avatar/plots/plot_waves/brainwaves-csv/takeoff
