...
class bciConnection():
    ...
    def send_data_to_server(self):
        ...
        global number
        number += 1
        temp_df = pd.read_csv(f"C:/Users/8pp84/Downloads/Skool/CSCI_495/data_repo/real/{number}.csv")
    ...
    def bciConnectionController(self):
        try:
            ...
            # format data cols.
            self.column_labels = ["SampleIndex","EXGChannel0","EXGChannel1","EXGChannel2","EXGChannel3","EXGChannel4","EXGChannel5",
                                  "EXGChannel6","EXGChannel7","EXGChannel8","EXGChannel9","EXGChannel10","EXGChannel11","EXGChannel12",
                                  "EXGChannel13","EXGChannel14","EXGChannel15","AccelChannel0","AccelChannel1","AccelChannel2",
                                  "Other0","Other1","Other2","Other3","Other4","Other5","Other6","AnalogChannel0","AnalogChannel1",
                                  "AnalogChannel2","Timestamp","Other7"]
